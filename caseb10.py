...
def main():
    ...
    result_dir = "/workspace/UndergraduateResearchAssistant/GraduateProject/sumo/4ways_result10"
    ...
    optimizer = optim.Adam(q.parameters(), lr=0.001) #0.0001
    ...
    for episode in range(episodes):
        ...
        cumulative_loss = 0.0  # 1000스텝 동안 누적된 loss 값
